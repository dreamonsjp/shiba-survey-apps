...
var Application = {
    ...
    sendingAData: function(saveddata)
    {
        ...
        if (g_sendingSurvey)
        {
            ...
            if (g_sendingSurvey.files && g_sendingSurvey.files.length > 0)
            {
                ...
                ft.upload(fileURI, feedUrl + "/upload.php", function(message) {
                    ...
                    {
                        //g_message += '<br/>Uploaded '+ fileURI.substr(fileURI.lastIndexOf('/')+1)+ " failed:" +returnValue.message;
                    }
    ...
    sendAllSavedData: function()
    {
        ...
        else
        {
            ...
            if (g_numSend == g_total2Send - 1)
                navigator.notification.alert('All your saved data has been submitted successfully.', function() {
                }, 'Send All Surveys');
            else
                navigator.notification.alert(g_numSend + ' your saved data has been submitted successfully.', function() {
                }, 'Send All Surveys');
    ...
    layoutDetailSurvey: function(returnData, sid, jscode, relevance) {
        ...
        $('#surveySubmit').append('<input type="submit" value="Save" id="buttonSubmit"/>');
        ...
        $('#surveySubmit').submit(function(event)
        {
            ...
            else
            {
                ...
                $('.rankingInputOrder').each(function(index, element)
                {
                    ...
                    var keyValue = $(this).attr("value"); // 0, 1, 2, 3, 4
    ...
    analyzeData: function(returnData, sid) {
        ...
        for (var index = 0; index < returnData.length; index++)
        {
            ...
            //console.log(anQuestion.question);
            ...
            case "R":
                {
                    ...
                    for (var index = 0; index < length; index++)
                    {
                        ...
                        htmlItems += '<input type="hidden" name="' + sid + "X" + anQuestion.gid + "X" + anQuestion.qid + "_SHIBASURVEYRANK_" + answerDetail.code + '" value="' + valueIndex + '" class="rankingInputOrder">';
    ...
    initLoginPage: function() {
        ...
        $('#url-add').val(Application.getRecentURL());
